$(document).ready(function () {
  ...
  function checkTotal() {
    ...
    // b. Set a timeout feature to get the message to disappear shortly after winning. ** Message shows up the first time and timeout 
    // works, BUT the message never shows up again for subsequent wins. **
    ...
    // d. Set a timeout feature to get the message to disappear shortly after losing. ** Message shows up the first time and timeout 
    // works, BUT the message never shows up again for subsequent losses. **
    if (numberCollected > randomNumber) {
      console.log("Sorry!");
      losses++;
      $("#losses").html(losses);
